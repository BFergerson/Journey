...
dependencies {
      ...
      compile 'com.github.codebrig:journey:0.2.13-69-online'

      //or use the offline version (includes native CEF files for all platforms; ~300MB)
      //compile 'com.github.codebrig:journey:0.2.13-69-offline'
}
```
...
<dependency>
	...
	<version>0.2.13-69-online</version>
	
	<!-- or use the offline version (includes native CEF files for all platforms; ~300MB) -->
	<!-- <version>0.2.13-69-offline</version> -->
</dependency>
```
