...
public interface CefBrowserProxy extends Reflect.ProxyObject {
    ...
    Reflect.ProxyValueConverter PROXY_VALUE_CONVERTER = (methodName, returnValue) -> {
        ...
        } else if ("getDevTools".equals(methodName)) {
...
//    void printToPDF(String path, CefPdfPrintSettings settings, CefPdfPrintCallback callback);
     ...
     */
    CefBrowserProxy getDevTools(Point inspectAt);
