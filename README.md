...
### Linux (64bit)
```sh
curl -L -O https://github.com/CodeBrig/Journey/releases/download/0.3.3-78-assets/jcef-distrib-linux64.zip
...
wget https://github.com/CodeBrig/Journey/releases/download/0.3.3-78-assets/jcef-distrib-windows64.zip -OutFile jcef-distrib-windows64.zip
