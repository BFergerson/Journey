...
dependencies {
      ...
      compile 'com.github.codebrig:journey:0.2.11-69-online'

      //or use the offline version (includes native CEF files for all platforms; 200MB+)
      //compile 'com.github.codebrig:journey:0.2.11-69-offline'
}
```
...
<dependency>
	...
	<version>0.2.11-69-online</version>
	
	<!-- or use the offline version (includes native CEF files for all platforms; 200MB+) -->
	<!-- <version>0.2.11-69-offline</version> -->
</dependency>
```
