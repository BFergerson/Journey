...
dependencies {
      compile 'com.github.codebrig:journey:0.4.1-online'

      //or use the offline version (includes native CEF files for all platforms; ~300MB)
      //compile 'com.github.codebrig:journey:0.4.1-offline'
}
```
...
<dependency>
	...
	<version>0.4.1-online</version>

	<!-- or use the offline version (includes native CEF files for all platforms; ~300MB) -->
	<!-- <version>0.4.1-offline</version> -->
</dependency>
```
